...
class InActiveGroupScreen extends StatelessWidget {
  InActiveGroupScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final taskControler = Get.put(TaskControler());
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final ActiveGroup = taskControler.taskGrouplist
            .where((group) => group.groupIsavtive == false)
            .toList();
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            print("API CALLED for ${group.groupId}");

            print('Group ID: ${group.groupId}');

            // final pcount = group.completedTasks?.length ?? 0;
